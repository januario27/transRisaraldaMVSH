...
public class ModMant extends CustomComponent {
	...
	private TabSheet buildTabSheet_1() {
		...
		tabSheet_1.addTab(absoluteLayout_2, "Registro Mantenimientos", null);
		...
		tabSheet_1.addTab(absoluteLayout_3, "Hist�rico Mantenimientos", null);
		...
		tabSheet_1.addTab(absoluteLayout_4, "Actualizacion de Informaci�n",
				null);
